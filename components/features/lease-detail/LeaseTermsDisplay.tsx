            ...
            <CardContent>
                <div className="grid gap-4 sm:grid-cols-2">
                    {terms.rent_increase_rate !== undefined && terms.rent_increase_rate > 0 && (
                        <div>
                            <div className="text-sm text-gray-500">Түрээсийн өсөлт</div>
                            <div className="font-medium">{terms.rent_increase_rate}%/жил</div>
                        </div>
                    )}

                    {terms.rent_increase_interval !== undefined && terms.rent_increase_interval > 0 && (
                        <div>
                            <div className="text-sm text-gray-500">Түрээс шинэчлэх хугацаа</div>
                            <div className="font-medium">{terms.rent_increase_interval} сар тутам</div>
                        </div>
                    )}

                    {terms.notice_period_days !== undefined && terms.notice_period_days > 0 && (
                        <div>
                            <div className="text-sm text-gray-500">Цуцлах мэдэгдлийн хугацаа</div>
                            <div className="font-medium">{terms.notice_period_days} хоногийн өмнө</div>
                        </div>
                    )}

                    {terms.renewal_terms && (
                        <div className="sm:col-span-2">
                            <div className="text-sm text-gray-500">Сунгах нөхцөл</div>
                    ...
                    {terms.special_conditions && (
                        <div className="sm:col-span-2">
                            <div className="text-sm text-gray-500">Тусгай нөхцөл</div>
